    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <?php foreach ($_SESSION['products'] as $product) : ?>
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <img class="cartItemImg" src="<?= '../' . $product['path'] ?>" alt="">
                ...
                <div class="d-flex flex-wrap mt-2">
                    <form action="cart.php" method="post" class="d-flex flex-wrap">
                        <div class="form-group">
                            <input type="number" name="quantity" class="form-control form-control-sm" value="<?= $product['quantity'] ?>" min="1" max="10" style="width: 50px">
                        </div>
